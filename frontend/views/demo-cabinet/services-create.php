...
<div class="goods-create">
    ...
    <h1 class="text-center">Создать услугу</h1>

    <div class="services-create">

        <form id="w0" class="form-horizontal" action="/admin/services/create" method="post" enctype="multipart/form-data">
            <input name="_csrf-frontend" value="MmdiRFBxY0oDPRp2GQdVAUdfBTI8GjctSA0MLj8VESdIBRZ1Yj4PEw==" type="hidden">
            <div class="form-group field-services-name required">
                <div class="col-sm-3 control-label"><label class="control-label" for="services-name">Название</label></div><div class="col-sm-7"><input id="services-name" class="form-control" name="Services[name]" maxlength="255" type="text"></div><div class="col-sm-7 col-sm-offset-3"><p class="help-block help-block-error"></p></div>
            </div>
            ...
            <div class="col-sm-12 col-sm-offset-0">
                <div class="col-sm-7">
                    <div class="form-group field-services-price">
                        <div class="col-sm-5 control-label"><label class="control-label" for="services-price">Цена</label></div><div class="col-sm-7"><input id="services-price" class="form-control" name="Services[price]" type="text"></div><div class="col-sm-7 col-sm-offset-5"><p class="help-block help-block-error"></p></div>
                    </div>            </div>
                <div class="col-sm-4">
