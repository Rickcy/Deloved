...
<div class="goods-create">
    ...
    <div class="goods-create">
        ...
        <form id="w0" class="form-horizontal" action="/admin/goods/create" method="post" enctype="multipart/form-data">
            <input name="_csrf-frontend" value="YXZJVXc4WGxQLDFnPk5uJxROLiMbUwwLGxwnPxhcKgEbFD1kRXc0NQ==" type="hidden">
            <div class="form-group field-goods-name required">
                <div class="col-sm-3 control-label"><label class="control-label" for="goods-name">Название</label></div><div class="col-sm-7"><input id="goods-name" class="form-control" name="Goods[name]" maxlength="255" type="text"></div><div class="col-sm-7 col-sm-offset-3"><p class="help-block help-block-error"></p></div>
            </div>
            <div class="form-group field-goods-model">
                <div class="col-sm-3 control-label"><label class="control-label" for="goods-model">Спецификация</label></div><div class="col-sm-7"><input id="goods-model" class="form-control" name="Goods[model]" maxlength="255" type="text"></div><div class="col-sm-7 col-sm-offset-3"><p class="help-block help-block-error"></p></div>
            </div>
            <div class="col-sm-12 col-sm-offset-0">
                <div class="col-sm-7">
                    <div class="form-group field-goods-price required">
                        <div class="col-sm-5 control-label"><label class="control-label" for="goods-price">Цена</label></div><div class="col-sm-7"><input id="goods-price" class="form-control" name="Goods[price]" type="text"></div><div class="col-sm-7 col-sm-offset-5"><p class="help-block help-block-error"></p></div>
                    </div>            </div>
                <div class="col-sm-4">
