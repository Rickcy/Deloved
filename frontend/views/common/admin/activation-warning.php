...
<div class="alert alert-info" style="padding: 10px; margin-bottom: 10px">
	...
	<ul>
		<li>
Вы зарегистровали учетную запись в системе, но еще не активировали её. На <b><?=$user->email?></b> после проверки модератором будут высланы дальнейшие инструкции.
		</li>
		<li>
Письмо должно должно придти в течении 5-15 минут после регистрации.
		</li>
		<li>
Если письмо не приходит после указанного времени, то попробуйте проверить раздел "Спам" в вашем почтовом ящике.
		</li>
		<li>
