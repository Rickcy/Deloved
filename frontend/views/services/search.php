...
/**
 * @var $item \common\models\Services;
 */
            ...
            <?php foreach ($acc as $item):?>
                <div class="row minicart lc">
                    ...
                    <div class="col-sm-4 col-xs-8" style="margin-top: 20px;" >
                        ...
                        <a target="_blank" href="/services/item/?id=<?=$item->id?>"><?=$item->name?></a>
                        ...
                        <a target="_blank" href="/services/item?id=<?=$item->id?>" class="podr" style="text-align: center" >
                            Подробнее
                        </a>
                    ...
                    <div class="col-xs-12 col-sm-5" >
                        ...
                        <div class="gray_block">
                            ...
                            <?php if (!Yii::$app->user->isGuest):?>
                                ...
                                <?php else:?>
                                    <a target="_blank" href="/admin/deal/create?service=<?=$item->id?>" class="deal_button" style="border: none;min-width: 143px; text-align: left" >Предложить сделку</a>
                                <?php endif;?>
                            <?php else:?>
