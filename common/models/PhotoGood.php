...
/**
 * This is the model class for table "photo_good".
 *
 * @property integer $id
 ...
 * @property Goods $item
 */
class PhotoGood extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['item_id'], 'exist', 'skipOnError' => true, 'targetClass' => Goods::className(), 'targetAttribute' => ['item_id' => 'id']],
        ];
    }
